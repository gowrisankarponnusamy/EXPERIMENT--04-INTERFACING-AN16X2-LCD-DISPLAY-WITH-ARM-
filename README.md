...
int main(void)
{
  ...
  Lcd_cursor(&lcd,0,1);
  Lcd_string(&lcd,"Gowrisankar p");
  Lcd_cursor(&lcd,1,1);
  Lcd_string(&lcd,"212222230041");
  /* Infinite loop */
...
## Output screen shots of proteus  :
 ![Screenshot (264)](https://github.com/user-attachments/assets/01cc2cfa-7aeb-4e3d-9b3c-3664aa2c6353)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/user-attachments/assets/5a7266f4-7056-427f-8fb3-507aca58757e)
